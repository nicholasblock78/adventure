...
Product.create({
    title: 'Goodthreads Socks',
    rating: '9',
    amazon: '<iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=US&source=ss&ref=as_ss_li_til&ad_type=product_link&tracking_id=20sadventures-20&language=en_US&marketplace=amazon&region=US&placement=B06Y5PVF9R&asins=B06Y5PVF9R&linkId=b7a47837ff5a485d1aa697d1cbb13af8&show_border=true&link_opens_in_new_window=true"></iframe>',
    body: "If you love wearing fun socks, these are for you! They are comfy and have bold, vibrant colors."
})